public class Driver 
{
	...
	{
		System.out.println(Driver.decimalToBase(123, 16));
		String s = "124";
	}
	...
	static String decimalToBase(int currNum, int radix)
	{
		String answerString = "";
		int nextNum;
		...
		while(currNum > 0)
		{
			nextNum = currNum % radix;  
			currNum = currNum / radix; 
			answerString = answerString + map.charAt(nextNum);
		}
			
			
			
			
		return Driver.reverseString(answerString);
	}
